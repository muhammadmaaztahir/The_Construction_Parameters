            ...
            <div style={{marginBottom: '80px'}} className="container">
                <div className="section-title text-center">
                    <div className="section-title__tagline-box">
                        <span className="section-title__tagline">Clients testimonials</span>
                    </div>
                    <h2 className="section-title__title">Real Stories, Real Impact</h2>
                </div>
                <div className="row">
                    <div className="col-xl-6">
                        <div className="testimonial-two__left">
                            <div className="testimonial-two__img">
                                <img src="assets/images/testimonial/testimonial-two-img-1.png" alt=""/>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-6">
